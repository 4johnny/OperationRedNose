...
- (NSNumber*)telegramBotUserID {
	
	return [[NSUserDefaults standardUserDefaults] valueForKey:@"telegramBotUserID"];
}


- (void)setTelegramBotUserID:(NSNumber*)telegramBotUserID {

	NSLog(@"Saving Telegram bot user ID to user defaults: %@", telegramBotUserID);
	
	[[NSUserDefaults standardUserDefaults] setValue:telegramBotUserID forKey:@"telegramBotUserID"];
}
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"ORN_Intake" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"ORN_Intake.sqlite"];
    NSError *error = nil;
