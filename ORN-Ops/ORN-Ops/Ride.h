...
@property (nonatomic, retain) NSString * locationEndState;
@property (nonatomic, retain) NSString * locationEndStreet;
...
@property (nonatomic, retain) NSString * locationStartState;
@property (nonatomic, retain) NSString * locationStartStreet;
